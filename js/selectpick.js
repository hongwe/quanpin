...
(function($, window, document, undefined) {
   ...
   $.fn.selectpick = function(options) {
      ...
      return this.each(function(elem_id) {
         ...
         // 生成的div的样式
         var _selectBody = "<div onselectstart='return false;' style='width: 1200px; margin: auto;'><div class='selectpick_div selectpick_div_" + elem_id + "'  id='selectpick_" + elem_id + "'><span style='float:left;' id='selectpick_span_" + elem_id + "'></span><span class='selectpick_icon' id='selectpick_icon_" + elem_id + "'></span></div><div class='selectpick_options selectpick_options_" + elem_id + "'></div></div>";
